...
public class Drive extends SubsystemBase implements Vision.VisionConsumer {
    ...
    public Drive(
        ...
        setpointGenerator = new SwerveSetpointGenerator(
                PP_CONFIG, // The robot configuration. This is the same config used for generating trajectories and
                // running path following commands.
                getMaxAngularSpeedRadPerSec() // The max rotation velocity of a swerve module in radians per second.
                );

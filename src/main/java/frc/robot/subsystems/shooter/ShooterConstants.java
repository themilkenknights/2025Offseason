...
public class ShooterConstants {
  ...
  public static record Setpoint(
      Angle pivotAngle, AngularVelocity bottomWheelSpeed, AngularVelocity topWheelSpeed) {}

  public static class motorConfigs {
    static TalonFXConfiguration shooterMotorConfigs =
        new TalonFXConfiguration()
            ...
            .withSlot0(new Slot0Configs().withKP(.1).withKD(0).withKS(0).withKV(0).withKA(0));

    TalonFXConfiguration feederMotor =
        new TalonFXConfiguration()
            .withCurrentLimits(
                new CurrentLimitsConfigs()
                    .withStatorCurrentLimit(60)
    ...
    TalonFXConfiguration angleMotor =
        new TalonFXConfiguration()
            .withCurrentLimits(
                new CurrentLimitsConfigs()
                    .withStatorCurrentLimit(60)
            ...
            .withSlot0(new Slot0Configs().withKP(12).withKD(0).withKS(0).withKV(0).withKA(0))
            .withMotionMagic(
